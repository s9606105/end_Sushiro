...
<style type ="text/css">
    ...
    .inner-border-frame-noimg .inner-border-frame-noimg-title {
        font-weight: bold;
    ...
    .inner-border-frame-noimg .inner-border-frame-noimg-font {
        font-weight: bold;
        padding: 20px;
        font-size: 18px;
    }
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="content-frame"> 
            <div class="container">
                <h2 class="inner-content-title">訂位相關</h2>
                <div class ="inner-border-frame-noimg">
                    <div class =" inner-border-frame-noimg-title">
                        <asp:Label ID="Q1" runat="server" Text=""></asp:Label>
                    </div>
                    <div class =" inner-border-frame-noimg-font">
                        <p>
                ...
                <h2 class="inner-content-title">外送與外帶</h2>
                <div class ="inner-border-frame-noimg">
                    <div class =" inner-border-frame-noimg-title">
                ...
                <h2 class="inner-content-title">結帳相關</h2>
                <div class ="inner-border-frame-noimg">
                    <div class =" inner-border-frame-noimg-title">
                ...
                <h2 class="inner-content-title">關於電子會員卡</h2>
                <div class ="inner-border-frame-noimg">
                    <div class =" inner-border-frame-noimg-title">
                ...
                <h2 class="inner-content-title">其他問題</h2>
                <div class ="inner-border-frame-noimg">
                    <div class =" inner-border-frame-noimg-title">
                ...
                <h2 class="inner-content-title">業務洽詢</h2>
                <div class ="inner-border-frame-noimg">
                    <div class =" inner-border-frame-noimg-title">
